...
ctr.x_final_tar_val = [0; 0; 0.2*9*0; 0.4*9; 0; 0.3]; % final target state r p y; x y z
ctr.dx_final_tar_val = [0; 0; 0.2*0; 0.4; 0; 0];
...
ctr.weight.Qc = 10*[400 400 400]'; % foot placement error on 3 axis
